 ...
 */
final class Version20220308205954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE participants (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, id_event_id INT NOT NULL, UNIQUE INDEX UNIQ_7169709279F37AE5 (id_user_id), UNIQUE INDEX UNIQ_71697092212C041E (id_event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE participants ADD CONSTRAINT FK_7169709279F37AE5 FOREIGN KEY (id_user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE participants ADD CONSTRAINT FK_71697092212C041E FOREIGN KEY (id_event_id) REFERENCES evenement (id)');
        $this->addSql('DROP TABLE bloglikes');
        $this->addSql('DROP TABLE ligne_commande');
        $this->addSql('DROP TABLE reset_password_request');
        $this->addSql('ALTER TABLE blog ADD likes INT NOT NULL');
        $this->addSql('ALTER TABLE classement CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP likes');
